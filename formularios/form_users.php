            ...
            <div class="col-12">
                <form action="operating_system.php" method="POST">
                    <div class="form-group">
                        ...
                        <label for="color">Fecha de Nacimiento</label>
                        <input type="text" name="fec_nac" class="form-control" id="">
                        <label for="color">Genero</label>
                        <input type="text" name="gender" class="form-control" id="">
                        <label for="color">Acepta Terminos y condiciones</label>
                        <input type="text" name="tyc" class="form-control" id="">                        
                    </div>                    
